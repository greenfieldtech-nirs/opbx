...
class BusinessHoursTimeRange extends Model
{
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'business_hours_time_ranges';
    ...
    /**
     * Get the schedule day that owns this time range.
     */
    public function scheduleDay(): BelongsTo
    {
        return $this->belongsTo(BusinessHoursScheduleDay::class, 'business_hours_schedule_day_id');
    }
