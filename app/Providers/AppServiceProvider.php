...
use App\Policies\CallTrackingNotificationSettingsPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(CallTrackingAdPlatformIntegration::class, CallTrackingAdPlatformIntegrationPolicy::class);
        Gate::policy(CallTrackingNumber::class, CallTrackingNumberPolicy::class);
        Gate::policy(CallTrackingNotificationSettings::class, CallTrackingNotificationSettingsPolicy::class);
