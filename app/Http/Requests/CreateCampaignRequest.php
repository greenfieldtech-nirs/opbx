...
class CreateCampaignRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'schedule.monday.time_ranges' => ['required', 'array'],
            ...
            'schedule.tuesday.time_ranges' => ['required', 'array'],
            ...
            'schedule.wednesday.time_ranges' => ['required', 'array'],
            ...
            'schedule.thursday.time_ranges' => ['required', 'array'],
            ...
            'schedule.friday.time_ranges' => ['required', 'array'],
            ...
            'schedule.saturday.time_ranges' => ['required', 'array'],
            ...
            'schedule.sunday.time_ranges' => ['required', 'array'],
