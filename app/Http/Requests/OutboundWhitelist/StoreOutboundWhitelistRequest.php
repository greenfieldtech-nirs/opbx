...
/**
 * Form request validator for creating a new outbound whitelist entry.
 */
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'destination_country' => [
                ...
                'string',
                'max:100',
                // Country must be unique within the organization
                Rule::unique('outbound_whitelists', 'destination_country')->where(function ($query) use ($user) {
