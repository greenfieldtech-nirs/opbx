...
/**
 * Form request validator for updating a ring group.
 */
class UpdateRingGroupRequest extends FormRequest
{
    ...
    {
        $user = $this->user();
        $ringGroup = $this->route('ring_group');
        ...
        return [
            'name' => [
                ...
                'min:2',
                'max:100',
                // Name must be unique within the organization, excluding current ring group
                Rule::unique('ring_groups', 'name')
