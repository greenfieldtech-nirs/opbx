...
/**
 * Form request validator for updating an existing phone number (DID).
 *
 * Validates routing configuration and ensures target resources exist, are active,
 * and belong to the same organization. The phone_number field itself is immutable.
 */
class UpdatePhoneNumberRequest extends FormRequest
{
    ...
    {
        return [
            // phone_number field is NOT allowed in updates (immutable)
            'phone_number' => [
                'prohibited',
            ],
            'friendly_name' => [
