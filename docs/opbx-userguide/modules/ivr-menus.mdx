...
After `max_turns` invalid inputs, the call routes to the failover destination. The failover supports the same destination types as options, except business hours.
