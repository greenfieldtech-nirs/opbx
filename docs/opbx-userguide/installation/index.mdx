...
:::tip Next Steps
Proceed to [First Login](./first-login) to create your organization and admin account. If you are enabling Auth0 social login, also see [Auth0 Setup](./auth0-setup).
:::
