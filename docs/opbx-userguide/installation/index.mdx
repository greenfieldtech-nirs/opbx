...
You also need ports 80, 3000, 6001, 4040, and 8081 available on your host machine.
...
| ngrok | 4040 | Webhook tunneling interface |
| dialer-worker | 8081 | CDR webhook listener |
