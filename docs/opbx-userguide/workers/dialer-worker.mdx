...
| `WEBHOOK_PORT` | `8081` | Yes | HTTP server port for CDR webhooks and health checks (container-internal; published to the host as 8181 by default, see `DIALER_WEBHOOK_HOST_PORT`) |
