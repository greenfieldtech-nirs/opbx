...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            DB::statement("ALTER TABLE extensions MODIFY COLUMN type ENUM('user','virtual','conference','ring_group','ivr','ai_assistant','custom_logic','forward','queue','ai_load_balancer') NOT NULL DEFAULT 'user'");
        }
    }
    ...
    public function down(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            // MySQL/PostgreSQL: Can use ALTER COLUMN
            // Note: This will fail if there are extensions with ai_load_balancer type
