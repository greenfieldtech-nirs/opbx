...
return new class extends Migration
{
     ...
     * - Adds: 'ai_load_balancer'
     */
    public function up(): void
    {
        // Modify the enum to add new routing type
    ...
    {
        // First, migrate any existing 'ai_load_balancer' records to 'extension'
        DB::table('did_numbers')
            ->where('routing_type', 'ai_load_balancer')
